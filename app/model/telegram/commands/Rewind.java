 ...
 * tfs ☭ sweat and blood
 */
public final class Rewind extends ACommand implements TgCommand, OfCallback, Paging {
    public Rewind(final long msgId, final long callbackId, final User user) {
        super(msgId, user, callbackId);
    }

    public static String mnemonic() {
        return Rewind.class.getSimpleName() + '.';
    }
