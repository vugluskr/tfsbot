 ...
 * tfs ☭ sweat and blood
 */
public final class RefreshView extends ACommand implements TgCommand {
    public RefreshView(final long msgId, final long callbackId, final User user) {
        super(msgId, user, callbackId);
    }

    public static String mnemonic() {
        return RefreshView.class.getSimpleName() + '.';
    }
