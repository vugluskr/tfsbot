...
public class HandlerService {
    ...
    private static final Logger.ALogger logger = Logger.of(HandlerService.class);
    ...
    public void handleJson(final JsonNode js) {
        final User user;
    ...
    public void handleUserRequest(final User user, final Consumer<User> task, final JsonNode input) {
        CompletableFuture.runAsync(() -> {
            try {
                task.accept(user);
            } finally {
