...
public class LangMap {
    ...
    static {
        ...
        init(Value.BOOKS_GENRES, "Genres", "По жанру");
        init(Value.BOOKS_AUTHORS, "Authors", "По автору");
        init(Value.BOOKS_ABC, "Titles", "По названию");
        ...
        init(Value.OPDS_FAILED, "OPDS synchronization failed. Try to repeat later.", "Синхронизация с OPDS каталогом не получилась. Повтори попытку немного позже.");
